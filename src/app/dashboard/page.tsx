    ...
    <AppLayout>
      ...
      <div className="p-6">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">Command Center</h2>
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">FY{activeYear?.year || '2026'} National Budget | Consolidated Overview</p>
          </div>
          <div className="flex items-center gap-2">
            {isRefreshing && <RefreshCw className="h-4 w-4 animate-spin text-emerald-500" />}
            <Badge variant="outline" className={cn(
              "gap-1.5 text-xs",
              autoRefresh ? "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400 dark:border-emerald-800" : "bg-slate-50 dark:bg-slate-800"
            )}>
