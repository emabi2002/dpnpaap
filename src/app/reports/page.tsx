    ...
    <AppLayout>
      <Header
        ...
        tabs={[
          ...
          { label: 'Cross-Check', href: '/reports/cross-check' },
        ]}
      />
      <div className="p-6 space-y-6">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Projected monthly cash outflow across all projects
              </CardDescription>
            </CardHeader>
            <CardContent>
              <CashflowLineChart
                data={MONTH_LABELS.map((month) => {
                  ...
                  return {
                    ...
                    projected: reportData.monthlyNational[monthKey],
                  };
                })}
              />
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <StatusPieChart
                data={[
                  { name: 'Approved', value: Math.floor(reportData.summary.totalProjects * (reportData.summary.approvalRate / 100)), color: '#22c55e' },
                  { name: 'Submitted', value: Math.floor(reportData.summary.totalProjects * 0.3), color: '#f59e0b' },
                  { name: 'Draft', value: Math.floor(reportData.summary.totalProjects * 0.2), color: '#94a3b8' },
                  { name: 'Returned', value: Math.floor(reportData.summary.totalProjects * 0.1), color: '#ef4444' },
                ]}
              />
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Total revised budget by agency
            </CardDescription>
          </CardHeader>
          <CardContent>
            <BudgetBarChart
              data={reportData.byAgency.slice(0, 6).map(row => ({
                name: row.agency.agencyCode || 'Unknown',
                budget: row.revisedBudget,
              }))}
            />
          </CardContent>
        </Card>
