        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div className="relative hidden md:block">
            ...
            <Input
              ...
              className="w-48 lg:w-64 pl-9 h-9 bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 focus:bg-white dark:focus:bg-slate-700"
            />
          </div>

          {/* Status Indicators - Hidden on mobile */}
          <div className="hidden lg:flex items-center gap-3 border-l dark:border-slate-700 pl-4">
            <div className="flex items-center gap-1.5 text-sm">
              <Wifi className="h-4 w-4 text-emerald-500" />
              <span className="text-slate-600 dark:text-slate-400">Online</span>
            </div>
            <div className="flex items-center gap-1.5 text-sm">
              <ConnectionStatusBadge showLabel={true} showRefresh={false} />
            </div>
          </div>
